...
<body>
    ...
    <!-- หน้าปก -->
    <section id="cover">
        <h2>ชื่อ นาย ธนวันต์ นามสกุล ด่านซ้าย</h2>
    ...
    <section id="profile">
        ...
        <p><strong>ชื่อ:</strong> นายธนวันต์ ด่านซ้าย</p>
        <p><strong>วันเกิด:</strong> วันอังคาร 7 เมษายน</p>
        <p><strong>อายุ:</strong> 17 ปี</p>
        <p><strong>งานอดิเรก:</strong> ยกเวท อ่านหนังสือ </p>
    </section>
    ...
    <section id="skills">
        ...
        <ul>
            <li>มีความรู้ในการออกกำลังกายโดยใช้เเรงต้าน</li>
            <li>เล่นกีฬา ฟุตบอลกับ บาสเก็ตบอล</li>
    ...
    <section id="contact">
        ...
        <p>โทรศัพท์ : 095 470 5465</p>
        <p>Email : s34858@banbung.ac.th</p>
        <p>instagram :thnwantdaanchaay</p>
    </section>
